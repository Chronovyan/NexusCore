...
# Copy the hook files
cp "${REPO_ROOT}/hooks/ps1/advanced-pre-commit.ps1" "$HOOKS_DIR/"
cp "${REPO_ROOT}/hooks/sh/advanced-pre-commit.sh" "$HOOKS_DIR/"
cp "${REPO_ROOT}/hooks/sh/advanced-pre-commit-wrapper" "$HOOKS_DIR/"
