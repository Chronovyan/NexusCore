...
# Copy the hook files
Copy-Item -Path "$RepoRoot/hooks/advanced-pre-commit.ps1" -Destination "$HooksDir/" -Force
Copy-Item -Path "$RepoRoot/hooks/advanced-pre-commit.sh" -Destination "$HooksDir/" -Force
Copy-Item -Path "$RepoRoot/hooks/advanced-pre-commit-wrapper" -Destination "$HooksDir/" -Force
